...
- Fosters learning through holding weekly once hours, and answering student questions during class and over email, provides detailed feedback on weekly assignments, quizzes and projects
- Introduction to Health Data Science course primarily focuses on tidyverse in R and basic biostatistics fundamental topics
- Introduction to Randomized Clinical Trials course focuses on the fundamentals of clinical trials which culminates in each student designing their own phase 3 protocol unitizing the PASS software
- Biostatistical Methods II course focuses on generalized linear models, as well as methods to handle longitudinal data, and survival data. 
- Statistical Methods for Casual Inference focuses on discussing causal graphs, randomization, model-based inference, and casual medication as well as various methodological tools. 
