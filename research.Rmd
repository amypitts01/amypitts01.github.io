...
This is home to all my academic accomplishments. A pdf copy of my CV is available  [here](AmyPitts_cv_oct2023.pdf). Please reach out if you have any questions. 
...
#### Summer Associate Healthcare Intern (Summer 2024)
Location: Analysis Group, New York, NY

- Applied statistical methods to gain insight into drug efficacy and patient reported outcomes in collaboration with leading pharmaceutical companies 
- Cleaned and explored electronic health data to help create a statistical analysis plan
- Designed a survey of physicians to gather critical insights on clinical practices, effectively informing subsequent chart reviews and enhancing understanding of healthcare trends and practices
...
- **Pitts, Amy J.** \& Fowler, Charlotte R. ``Comparison of open-source software for plotting directed acyclic graphs"  [arXiv preprint arXiv:2305.12006](https://arxiv.org/pdf/2305.12006.pdf) (2023).
- **Pitts, Amy,** & Patil, Sujata. "Missing data in cancer studies" in preparation.

#### Presentations

-	Pitts, Amy. "Using a separable effects model to overcome extreme positivity violation and distinguish the causal effects of surgery and anesthesia" Eastern North American Region (ENAR). Baltimore, MD. Mar 2024. 
...
-	Pitts, Amy. "Multilevel Regression & Poststratification with Population Margins: Application to HIV Inference" Joint Statistical Meeting (JSM), Portland OR. Aug 2024.
- Pitts, Amy.  "Using a separable effects model to overcome extreme positivity violation and distinguish the causal effects of surgery and anesthesia" American Causal Inference Conference (ACIC). Seattle, WA. May 2024. 
...
- Poster Award from the Joint Statistical Meeting Survey Research Method Section at the 2024 Joint Statistical Meetings in Portland, Oregon (2024)
- Travel award from the Survey Research Methods Section to attend the 2024 Joint Statistical Meetings in Portland, Oregon (2024)
